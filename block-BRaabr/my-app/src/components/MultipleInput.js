    ...
    return (
      <>
        <form>
          ...
          <input type="text" id="text" value={this.state.inputText} onChange={this.handleChange} />
          ...
          <textarea onChange={this.handleChange} value={this.state.textarea} rows="3" />
          <label htmlFor="text">TextArea Disabled: </label>
          <textarea onChange={this.handleChange} value={this.state.textarea} rows="3" disabled />
