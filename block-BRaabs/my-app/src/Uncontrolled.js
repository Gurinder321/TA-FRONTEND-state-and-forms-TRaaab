        ...
        <form className="flex">
          ...
          <div className="column">
            ...
            <div>
              <label>ZIP/Postal Code</label>
              <div>
                <input value={billingData.zip} type="text" placeholder="e.g. 176057" />
              </div>
            </div>
            <div>
              <label>City</label>
              <div>
                <input value={billingData.city} type="text" placeholder="e.g New Delhi" />
              </div>
            </div>
            <div>
              <label>Country</label>
              <div>
                <input value={billingData.country} type="text" placeholder="e.g India" />
              </div>
            </div>
          </div>
        </form>
